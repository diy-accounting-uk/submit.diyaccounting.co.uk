  ...
  projects: [
    {
      ...
      testMatch: [
        ...
        "**/itsaObligations.behaviour.test.js",
        "**/itsaSelfEmploymentPeriod.behaviour.test.js",
        "**/itsaAnnualSubmission.behaviour.test.js",
        "**/itsaFinalDeclaration.behaviour.test.js",
    ...
    {
      name: "itsaObligationsBehaviour",
      testDir: "behaviour-tests",
      testMatch: ["**/itsaObligations.behaviour.test.js"],
      workers: 1,
      outputDir: "./target/behaviour-test-results/",
      timeout: 300_000,
    },
    {
      name: "itsaSelfEmploymentPeriodBehaviour",
      testDir: "behaviour-tests",
      testMatch: ["**/itsaSelfEmploymentPeriod.behaviour.test.js"],
      workers: 1,
      outputDir: "./target/behaviour-test-results/",
      timeout: 300_000,
    },
    {
      name: "itsaAnnualSubmissionBehaviour",
      testDir: "behaviour-tests",
      testMatch: ["**/itsaAnnualSubmission.behaviour.test.js"],
      workers: 1,
      outputDir: "./target/behaviour-test-results/",
      timeout: 300_000,
    },

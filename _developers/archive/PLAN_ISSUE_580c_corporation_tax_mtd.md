...
> Parent plan: `PLAN_ISSUE_15_limited_company_endpoints.md` (pre-migration #580, now issue #15).
> Siblings: #580a (CH reads, covered by the parent plan), #580b (CH filings, `_developers/archive/PLAN_ISSUE_580b_companies_house_filings.md`).

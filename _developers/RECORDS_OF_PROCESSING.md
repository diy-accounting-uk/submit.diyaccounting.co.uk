...
| **Evidence** | `app/data/dynamoDbPracticeClientRepository.js:70-86` (data fields); `PLAN_PRICE_UPDATE.md:103-177` (processing purpose, data subject category); `infra/main/java/co/uk/diyaccounting/submit/stacks/DataStack.java:873-879` (storage and PITR). |
...
| **Evidence** | `app/functions/practice/practiceClientAuthorisationInvitePost.js:108-125` (invitation flow); `app/functions/practice/practiceClientAuthorisationGet.js:103-124` (status check and caching); `PLAN_PRICE_UPDATE.md:173-176` (stored attributes); `app/data/dynamoDbPracticeClientRepository.js:247-280` (storage method). |

...
| Testing in the last two weeks | Yes | The sandbox year ran for 2023-24, 2025-26 and 2026-27 on 2026-09-25 (`e8f6d942`), each with a real `Gov-Client-Multi-Factor` header; the fraud prevention header validator answered `VALID_HEADERS` on all three. Re-run `scripts/itsa-sandbox-year.js` within two weeks of sending, because HMRC keeps its testing logs for 14 days | `ITSA_PHASE_2_SANDBOX.md` |

...
| Property Business | `hmrcItsaUkPropertyPeriod*.js` (4), `hmrcItsaUkPropertyAnnual*.js` (2) | Simulator and behaviour tests; sandbox not evidenced |
...
| Individual Losses | `hmrcItsaLossesAndClaims*.js` (3) | Simulator and behaviour tests; sandbox not evidenced |
| Individuals Tax Liability Adjustments | `hmrcItsaTaxLiabilityAdjustments*.js` (3) | Simulator and behaviour tests; sandbox not evidenced |

## What a reviewer will ask that this file cannot answer yet

- A sandbox run that covers UK property, losses and claims, tax liability adjustments and the
  cumulative model. `scripts/itsa-sandbox-year.js` covers the self-employment dated year only.

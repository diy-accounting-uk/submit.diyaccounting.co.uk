...
Gateway (diyaccounting.co.uk) is managed by `support-at-diyaccounting/www.diyaccounting.co.uk`. Root DNS and holding page are managed by `support-at-diyaccounting/root.diyaccounting.co.uk`.

...
class DataStackTest {
    ...
    void excludedTablesGetNoStreamUpdate() {
        ...
        for (String tableName : new String[] {
            ...
            dataStack.hmrcItsaStatusGetAsyncRequestsTable.getTableName(),
            ...
            dataStack.hmrcItsaLossesAndClaimsGetAsyncRequestsTable.getTableName(),
            dataStack.hmrcItsaLossesAndClaimsPutAsyncRequestsTable.getTableName(),
            dataStack.hmrcItsaLossesAndClaimsDeleteAsyncRequestsTable.getTableName(),
            dataStack.hmrcItsaTaxLiabilityAdjustmentsGetAsyncRequestsTable.getTableName(),
            dataStack.hmrcItsaTaxLiabilityAdjustmentsPutAsyncRequestsTable.getTableName(),
            dataStack.hmrcItsaTaxLiabilityAdjustmentsDeleteAsyncRequestsTable.getTableName(),
            dataStack.companiesHouseAccountsAsyncRequestsTable.getTableName(),

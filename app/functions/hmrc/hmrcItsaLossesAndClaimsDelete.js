    ...
    try {
      ...
      if (!tokenResult.consumed) {
        ...
        await recordSubmissionFailure({
          ...
          summary: "ITSA losses and claims deletion blocked: submission allowance used up",
          userSub,
        });
      ...
      await recordSubmissionFailure({
        ...
        summary: "ITSA losses and claims deletion failed while checking the submission allowance",
        userSub,
      });
      return http500ServerErrorResponse({
        request,

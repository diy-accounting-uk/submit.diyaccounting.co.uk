...
export async function ingestHandler(event) {
  ...
  // No token charge here: losses and claims is a free year-end working step inside a year end
  // the final declaration charges for, and a customer working out how to use a loss will save

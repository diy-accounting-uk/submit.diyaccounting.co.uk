...
export function apiEndpoint(app) {
  registerLambdaRoute(app, "get", "/api/v1/companies-house/transaction/:transactionId", ingestHandler);
  registerLambdaRoute(app, "head", "/api/v1/companies-house/transaction/:transactionId", ingestHandler);
}
/* v8 ignore stop */

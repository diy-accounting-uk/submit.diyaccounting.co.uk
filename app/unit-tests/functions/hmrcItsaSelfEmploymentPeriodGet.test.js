...
describe("hmrcItsaSelfEmploymentPeriodGet ingestHandler - cumulative tax year", () => {
  beforeEach(() => {
    Object.assign(process.env, setupTestEnv());
    mockFetch = setupFetchMock();
    vi.resetAllMocks();
  ...
  test("does not require a periodId", async () => {
    mockHmrcSuccess(mockFetch, { periodIncome: { turnover: 5000 } });

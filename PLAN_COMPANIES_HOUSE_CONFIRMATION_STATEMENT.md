...
| CS-H1 | Credit account | Complete the Companies House credit account application form, send it to `chdfinance@companieshouse.gov.uk`, ask for it to be linked to presenter E0000052288. The account opened on 2026-09-25 under a new presenter ID, which authenticates on the live gateway since 2026-09-26 and is the live presenter. Identifiers in `../NEXT_OPERATOR_RUNBOOK.md` task A | none in the repository | 0 | none | none | human-driven |

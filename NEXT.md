...
| B vat-reads | Sonnet design, then Sonnet | B32.1, B32.2, B32.3 | merged 8a62c21e; remainder: the three new simulator behaviour tests time out waiting for results (deploy run 33771108157), fix in flight; environment deploy 33773949307 failed: the new tables' EnsureTTL and EnsurePITR custom resources race DynamoDB's one-change-at-a-time rule, CDK fix in flight |

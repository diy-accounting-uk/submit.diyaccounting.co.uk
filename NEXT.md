...
is on main. B11's T1 and T2 are on `claude/b15-board` and its T3 runs there now.
...
- [ ] **B11. ITSA phase 2: annual summaries and the final declaration.** The design is
  ...
  books-to-submission path after T8 and T6, and T10 the recognition pack after T7. T1 and T2
  are on batch 15 (`claude/b15-board`, on top of batch 14) and T3 runs now; T4 onward start

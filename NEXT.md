...
| B vat-reads | Sonnet design, then Sonnet | B32.1, B32.2, B32.3 | merged 8a62c21e; scenario, 400-mapping, return-fallback and verify-wait fixes merged (last dd7f5b7d); push deploy 33800795175 green on re-run (one post-return simulator timing flake, wait-budget fix in flight); sandbox-lane run 33803768153 dispatched |
